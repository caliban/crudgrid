...
public class Icons {
	...
	public static final Icon CANCEL = new PackageIcon(Icons.class, "res/icons/Cancel-icon.png");
	
	public static final Icon DELETE = new PackageIcon(Icons.class, "res/icons/16-em-cross.png");
	
	public static final Icon KICK = new PackageIcon(Icons.class, "res/icons/16-em-kick.png");
